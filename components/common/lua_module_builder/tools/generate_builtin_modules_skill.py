...
def render_generated_skill(entries: list[dict]) -> str:
    ...
    lines.extend(['To read documentation for a module, call `read_file("/system/scripts/docs/<Doc file path>")`.',
                  'To read a module test script, call `read_file("/system/scripts/builtin/test/<Test script path>")`.',
